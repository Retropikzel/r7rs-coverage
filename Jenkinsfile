pipeline {
    ...
    parameters {
        string(name: 'SCHEMES', defaultValue: 'capyscheme chibi chicken cyclone foment gauche gambit goldfish guile kawa larceny loko meevax mit-scheme mosh racket sagittarius skint stklos tr7 ypsilon', description: '')
    }
